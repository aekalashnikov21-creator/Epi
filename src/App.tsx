        ...
        <div className="flex flex-col gap-3 border-b border-paper-100/10 py-5 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:justify-end">
            ...
            <button
              onClick={onExport}
              disabled={exporting}
              className="press inline-flex items-center gap-2 rounded-full bg-gold-500 px-5 py-2.5 text-[12.5px] font-bold text-ink-950 shadow-[0_14px_30px_-12px_rgba(36,27,18,0.9)] ring-1 ring-paper-50/40 transition-all duration-200 hover:scale-[1.04] hover:bg-gold-400 disabled:cursor-wait disabled:opacity-75"
